...
class role_waarneming::sites (
  ...
  $certs_and_keys = {
    ...
    '/etc/nginx/ssl/observation_org-chained.crt' => { content => $::role_waarneming::conf::observations_org_crt },
    ...
    '/etc/nginx/ssl/observation_org.key' => { content => $::role_waarneming::conf::observations_org_key },
